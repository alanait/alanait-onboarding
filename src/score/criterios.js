...
export const CRITERIOS = [
  ...
  { id: "pcs_parcheo_sistema", dominio: "endpoint", seccion: "pcs", campo: "parcheo_gestion", peso: 3, mapa: { "Centralizada por RMM": 1, "WSUS / Intune / GPO": 0.85, "Windows Update automático sin control": 0.5, "Manual por el usuario": 0, "Sin gestión": 0 }, agregacion: "min",
  ...
  { id: "pcs_parcheo_terceros", dominio: "endpoint", seccion: "pcs", campo: "parcheo_terceros", peso: 2, mapa: { "Centralizada por RMM": 1, "Automática de cada aplicación": 0.5, Manual: 0.2, "Sin gestión": 0 }, agregacion: "min",
  ...
  { id: "av_tipo_solucion", dominio: "endpoint", seccion: "antivirus", campo: "tipo", peso: 2, mapa: { "Antivirus básico": 0.25, EDR: 0.8, XDR: 0.9, "MDR gestionado": 1 }, agregacion: "min",
    porQue: "El antivirus de firmas no ve el ransomware moderno, que llega sin fichero, por eso se queda en 0.25 y no a medio camino: no es media proteccion, es proteccion contra la amenaza de hace diez anos. Del EDR hacia arriba los saltos son cortos a proposito: el gran diferencial del MDR -que alguien vigile la consola 24x7- ya lo mide av_alertas_vigiladas, y contarlo tambien aqui seria puntuar el mismo hecho dos veces. Lo que se gradua aqui es solo el alcance de la tecnologia: EDR mira el puesto, XDR correlaciona ademas red e identidad (CIS 10.7)" },
  ...
  { id: "av_consola_control", dominio: "endpoint", seccion: "antivirus", campo: "consola_acceso", peso: 2, mapa: { "El cliente": 1, "El proveedor anterior": 0.25, Ambos: 0.5, "Nadie / credenciales perdidas": 0 }, agregacion: "min",
  ...
  { id: "srv_so_version_windows_server", dominio: "endpoint", seccion: "servidores", campo: "so_windows_server", peso: 2, mapa: { "Windows Server 2025": 1, "Windows Server 2022": 1, "Windows Server 2019": 0.85, "Windows Server 2016": 0.5, "Windows Server 2012 R2": 0, "Windows Server 2012": 0, "Windows Server 2008 R2": 0, "Windows Server 2008": 0, "Anterior a 2008": 0 }, dep: { field: "so_familia", value: "Windows Server" }, agregacion: "min", critico: { cuando: ["Windows Server 2012 R2", "Windows Server 2012", "Windows Server 2008 R2", "Windows Server 2008", "Anterior a 2008"], capDominio: 45 },
  ...
  { id: "sai_sala", dominio: "fisica", seccion: "sai", campo: "sala_tipo", peso: 2, mapa: { "Sala técnica dedicada": 1, "Despacho u oficina": 0.6, "Almacén": 0.4, "Zona de paso": 0 }, agregacion: "min",
